...
export async function main(args = process.argv.slice(2)) {
  ...
  const captureFailureDiagnostics = async () => {
    ...
    const captures = [
      ...
      ['logcat-runtime', ['shell', 'logcat', '-d', '-v', 'threadtime', '-t', '4000', 'AndroidRuntime:E', 'System.err:W', 'RustStdoutStderr:I', 'UacNative:I', 'UacBoot:I', 'UacScan:I', 'chromium:W', 'cr_*:W', 'CameraX:W', 'Camera*:W', '*:S']],
