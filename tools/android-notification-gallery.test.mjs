...
test('actual UI evidence cannot be absent or called withdrawn while still visible', () => {
  assert.doesNotThrow(() => checkNotificationUi('<hierarchy><node text="UAC 인증 요청 PowerShell"/></hierarchy>', 'sound'));
  assert.doesNotThrow(() => checkNotificationUi('<hierarchy></hierarchy>', 'withdrawn'));
