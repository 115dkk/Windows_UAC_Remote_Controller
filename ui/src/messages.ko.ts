...
export const ko = {
  ...
  phones: '휴대폰 관리',
  network: '외부 연결',
  networkIntro: '휴대폰이 집 밖에서도 이 PC에 연결할 수 있게 설정합니다.',
  networkSetup: '외부 연결 설정',
  computers: '연결된 PC',
  requests: '요청',
  schedule: '알림 시간',
  activity: '활동 기록',
  ...
  loadFailure: '앱 상태를 불러오지 못했습니다. [다시 확인]을 누르십시오. 계속되면 앱을 닫았다가 다시 여십시오.',
  ...
  requestWaiting: '선택을 PC로 보낼 준비를 하는 중입니다.',
  sending: '선택을 PC로 보내는 중입니다.',
  ...
  servicePausedBody: '휴대폰 승인이 일시 정지되어 있습니다. [휴대폰 승인 다시 켜기]를 누르십시오.',
  ...
  phoneServiceReadyBody: '받은 요청은 [요청] 화면에 표시됩니다.',
  policyUnavailableTitle: '알림 시간 설정을 읽을 수 없어요',
  policyUnavailableBody: '[다시 확인]을 누르십시오. 설정을 불러온 뒤 변경할 수 있습니다.',
  ...
  policyDraftKept: '저장하지 않은 내용은 이 화면에 남아 있습니다. 설정을 다시 불러오면 이어서 수정할 수 있습니다.',
  devicesUnavailable: '연결된 기기를 확인할 수 없어요',
  devicesUnavailableBody: '기기 목록을 불러오지 못했습니다. [다시 확인]을 누르십시오.',
  devicesUnavailableStoppedBody: '휴대폰 승인이 꺼져 있어 휴대폰 목록을 표시할 수 없습니다. 휴대폰 승인을 켜면 다시 표시됩니다.',
  ...
  relayUnconfigured: '저장된 외부 중계 서버 주소가 없습니다.',
  pairPhone: 'QR 코드 보기',
  ...
  pairingPcCheck: '[PC 상태]에서 휴대폰 승인이 켜져 있는지 확인하십시오.',
  pairingPcRelayFirst: '휴대폰이 접속할 준비가 되지 않아 QR 코드를 표시할 수 없습니다. PC의 네트워크 연결과 [외부 연결] 설정을 확인하십시오.',
  pairingPcOpenStatus: 'PC 상태 열기',
  pairComputer: 'PC 연결',
  openPairingScanner: 'PC의 QR 코드 촬영',
  pairingGuide: 'PC의 UAC 원격 승인 앱에서 ‘휴대폰 관리’ → ‘UAC 원격 승인’을 눌러 QR 코드를 여세요. 아래 버튼을 누르면 이 앱에서 카메라가 열려요.',
  pairingScannerNotReady: '지금은 카메라를 열 수 없습니다. [알림 시간] 화면에서 휴대폰 승인이 켜져 있는지 확인하십시오.',
  pairingScannerBusy: '앱이 다른 작업을 처리하는 중입니다. 잠시 후 [PC의 QR 코드 촬영]을 다시 누르십시오.',
  pairingScannerFailure: 'QR 읽기 화면을 열지 못했습니다. [다시 확인]을 누른 뒤 다시 시도하십시오.',
  ...
  saveDiagnostics: '진단 로그 파일로 저장',
  diagnosticsSaved: '선택한 위치에 진단 로그를 저장했습니다.',
  diagnosticsSaveCancelled: '파일 저장을 취소했습니다.',
  diagnosticsSaveFailure: '진단 로그를 저장하지 못했습니다. 저장 위치와 여유 공간을 확인한 뒤 다시 시도하십시오.',
  diagnosticsExported: '진단 로그 파일을 저장하고 공유 화면을 열었습니다.',
  diagnosticsExportFailure: '진단 로그를 내보내지 못했습니다. 잠시 후 다시 시도하십시오.',
  ...
  activityUnavailableBody: '활동 기록을 불러오지 못했습니다. [다시 확인]을 누르십시오.',
  activityUnavailableStoppedBody: '휴대폰 승인이 꺼져 있어 활동 기록을 표시할 수 없습니다. 휴대폰 승인을 켜면 다시 표시됩니다.',
  connectionUnknown: '휴대폰 연결 상태 확인 불가',
  ...
  lockUnknownBody: '[다시 확인]을 누르십시오. 계속되면 앱을 닫았다가 다시 여십시오.',
  ...
  notificationsUnknown: '휴대폰 알림 권한을 확인하지 못했습니다. 휴대폰 설정에서 이 앱의 알림이 켜져 있는지 확인하십시오.',
