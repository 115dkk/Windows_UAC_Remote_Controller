...
internal class PairingScannerDialog(
    ...
    fun show(): Boolean {
        ...
        if (!live()) { AndroidDiagnosticStore.record("UacScan", "stage=show reason=not_live"); return false }
        ...
        dialog.show()
        AndroidDiagnosticStore.record("UacScan", "stage=show shown=${dialog.isShowing}")
        window.setLayout(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT)
        content.focusHeading()
        if (!live() || !dialog.isShowing) { AndroidDiagnosticStore.record("UacScan", "stage=show reason=not_live_after_show"); close(); return false }
        ...
        val owned = actor.beginPairingScan(ticket, { result ->
            ...
            AndroidDiagnosticStore.record("UacScan", "stage=begin_scan result=${result.name} cancelled=${ticket.isCancelled()}")
