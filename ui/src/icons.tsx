...
export type IconName = 'pc' | 'phone' | 'request' | 'clock' | 'history' | 'refresh' | 'chevron' | 'lock' | 'link' | 'alert' | 'check' | 'close' | 'plus' | 'qr' | 'settings' | 'globe';
...
export function Icon({ name, className = '' }: { name: IconName; className?: string }) {
  const paths: Record<IconName, ReactNode> = {
    ...
    globe: <><circle cx="12" cy="12" r="9" /><path d="M12 3c-2.5 2.4-3.8 5.4-3.8 9s1.3 6.6 3.8 9c2.5-2.4 3.8-5.4 3.8-9S14.5 5.4 12 3ZM3.6 9h16.8M3.6 15h16.8" /></>,
