...
export const galleryCases: readonly GalleryCase[] = [
  ...
  row('desktop-connected-980', 'desktop-connected', 980, 740),
  row('desktop-connected-dark-760', 'desktop-connected', 760, 900, 'overview', 'dark'),
  ...
  row('desktop-relay-stopped-760', 'desktop-relay-stopped', 760, 740),
  ...
  row('desktop-qr-ready-narrow-390', 'desktop-pairing-ready', 390, 844, 'overview', 'dark'),
  { ...row('desktop-qr-ready-text-200-760', 'desktop-pairing-ready', 760, 900), rootTextSizePercent: 200 },
  ...
  row('phone-devices-pairing-dark-390', 'phone-devices-pairing', 390, 844, 'overview', 'dark'),
  row('phone-devices-pairing-narrow-320', 'phone-devices-pairing', 320, 740),
  { ...row('phone-devices-pairing-text-200-390', 'phone-devices-pairing', 390, 1000, 'overview', 'dark'), rootTextSizePercent: 200 },
  ...
  row('phone-waiting-320', 'phone-waiting', 320, 740),
  row('phone-awaiting-outcome-390', 'phone-awaiting-outcome', 390, 844),
  row('phone-history-390', 'phone-history', 390, 844),
  row('phone-history-results-390', 'phone-history-results', 390, 844),
  row('phone-forget-offline-pc-390', 'phone-devices-offline', 390, 844),
  row('phone-history-results-dark-390', 'phone-history-results', 390, 844, 'overview', 'dark'),
