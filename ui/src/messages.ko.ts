...
export const ko = {
  ...
  pairingPcCheck: 'PC 상태에서 실행 상태를 다시 확인해 주세요.',
  pairingPcRelayFirst: '네트워크 연결을 확인하고 외부 연결 화면에서 내장 중계를 사용한 뒤 QR 코드를 표시하십시오.',
  ...
  pairingScannerNotReady: '카메라를 열 준비가 되면 촬영할 수 있어요. 알림 시간 화면에서 휴대폰 승인 상태를 확인해 주세요.',
