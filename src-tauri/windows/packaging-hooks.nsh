...
LangString UacUnsafe 1042 "설치 위치나 폴더 권한이 예상과 달라 작업을 중단했습니다. 기록, 설정과 기기 연결 정보는 삭제하지 않았습니다. 설치 폴더(C:\Program Files\휴대폰 승인)의 권한을 확인한 뒤 다시 실행하십시오."
...
LangString UacStopFailed 1042 "실행 중인 휴대폰 승인 서비스를 중지하지 못했습니다. 프로그램 파일은 교체하지 않았습니다. 잠시 후 설치 프로그램을 다시 실행하십시오."
...
LangString UacInstallFailed 1042 "휴대폰 승인 서비스를 설치하지 못했습니다. 기록, 설정과 기기 연결 정보는 그대로 두었습니다. 설치 프로그램을 다시 실행하십시오."
...
LangString UacStartFailed 1042 "휴대폰 승인 서비스를 시작하지 못해 설치를 마치지 못했습니다. 기록, 설정과 기기 연결 정보는 그대로 두었습니다. 설치 프로그램을 다시 실행하십시오."
...
LangString UacRemoveFailed 1042 "휴대폰 승인 서비스를 제거하지 못했습니다. 프로그램 파일, 기록, 설정과 기기 연결 정보는 그대로 두었습니다. 잠시 후 제거를 다시 실행하십시오."
...
LangString UacFileFailed 1042 "프로그램 파일을 처리하지 못했습니다. 기록, 설정과 기기 연결 정보는 삭제하지 않았습니다. 앱을 닫은 뒤 다시 실행하십시오."
...
LangString UacCopyFailed 1042 "프로그램 파일을 설치하지 못했습니다. 기록, 설정과 기기 연결 정보는 그대로 두었습니다. 앱을 닫은 뒤 설치 프로그램을 다시 실행하십시오."
...
LangString UacWebViewRequired 1042 "이 PC에서 Microsoft Edge WebView2 Runtime을 찾지 못했습니다. Microsoft 웹사이트에서 WebView2 Runtime을 설치한 뒤 다시 설치하십시오. 프로그램 파일은 설치하지 않았습니다."
...
LangString UacAppRunning 1042 "앱이 열려 있어 프로그램 파일을 바꿀 수 없습니다. 앱을 닫고 계속하시겠습니까? 기록, 설정과 기기 연결 정보는 바뀌지 않습니다."
...
LangString UacAppOpen 1042 "앱을 연 채로 두어 작업을 중단했습니다. 프로그램 파일은 바꾸지 않았고 기록, 설정과 기기 연결 정보는 그대로입니다. 앱을 닫은 뒤 다시 실행하십시오."
...
LangString UacAppCloseFailed 1042 "열려 있는 앱을 닫지 못했습니다. 프로그램 파일은 바꾸지 않았고 기록, 설정과 기기 연결 정보는 그대로입니다. 앱을 직접 닫은 뒤 다시 실행하십시오."
