...
LangString UacShortcutsSubtitle 1042 "앱을 열 위치를 선택하십시오."
LangString UacShortcutsSubtitle 1033 "Choose where you will open the app."
LangString UacShortcutsFresh 1042 "새로 설치합니다. 추가할 바로가기를 선택하십시오."
...
LangString UacShortcutTaskbar 1042 "작업 표시줄에 추가 (설치 후 앱에서 확인)"
LangString UacShortcutTaskbar 1033 "Add to taskbar — confirm with Windows in the app"
LangString UacShortcutHint 1042 "작업 표시줄에 추가하려면 시작 메뉴 바로가기도 필요하므로 함께 선택됩니다. 설치 후 앱을 열면 고정 방법을 안내합니다. 일부 Windows 버전에서는 직접 고정해야 합니다."
