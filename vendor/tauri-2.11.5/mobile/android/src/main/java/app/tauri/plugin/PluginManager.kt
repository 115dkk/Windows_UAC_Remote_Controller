...
object PluginManager {
  ...
  fun runCommand(id: Int, pluginId: String, command: String, data: String) {
    runCommandInternal(id, pluginId, command, data, null)
  }

  @JniMethod
  fun runCommandForOrigin(id: Int, pluginId: String, command: String, data: String, originatingWebView: WebView) {
    runCommandInternal(id, pluginId, command, data, originatingWebView)
  }

  private fun runCommandInternal(id: Int, pluginId: String, command: String, data: String, originatingWebView: WebView?) {
    val successId = 0L
    val errorId = 1L
    ...
    }, data, jsonMapper, originatingWebView)
